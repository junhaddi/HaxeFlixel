...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("HaxeFlixel", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("HaxeFlixel", null, 640, 480);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "HaxeFlixel";
		app.meta["name"] = "HaxeFlixel";
